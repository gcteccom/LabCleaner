...
public class Login extends JFrame {
	...
	public Login(){
		...
		Image icono = Toolkit.getDefaultToolkit().getImage("src/Icono Lab-Cleaner.png");
		...
		img_candado=new ImageIcon("src/candado.png");
		candado=new JLabel(img_candado);
		candado.setBounds(200, 75, 100, 30);
		panel.add(candado);
		
		ImageIcon icono_aceptar=new ImageIcon("src/aceptar_16.png");
		ImageIcon icono_salir=new ImageIcon("src/salir.png");
